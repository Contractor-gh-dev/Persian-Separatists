...
public class ShowNanitePersonVisual extends BaseCommandPlugin {
	...
	public boolean execute(String ruleId, InteractionDialogAPI dialog, List<Token> params, Map<String, MemoryAPI> memoryMap) {
		...
		PersonAPI person = Global.getSector().getFaction(ContractorStaticVars.CONTRACTOR_NANITE_ID).createRandomPerson();
