...
public class SepFenarPlanetMissionCMD extends BaseCommandPlugin {
	public static final String id = "sepFenarPlanetMission";

	@Override
	public boolean execute(String ruleId, InteractionDialogAPI dialog, List<Misc.Token> params, Map<String, MemoryAPI> memoryMap) {
		if (dialog == null) return false;

		MarketAPI separatistCapital = Global.getSector().getEconomy().getMarket("separatists_sedna_market");
		String missionId = id;
		...
		mission.createAndAbortIfFailed(separatistCapital, false);
