...
public class NaniteFleetBehaviorScript implements EveryFrameScript {
	...
	public NaniteFleetBehaviorScript(CampaignFleetAPI fleet, StarSystemAPI system) {
		this.fleet = fleet;
		this.system = system;
		pickNext();
	}
	...
	protected void pickNext() {
		...
		fleet.addAssignment(FleetAssignment.PATROL_SYSTEM, target, days, "hunting");
	}
