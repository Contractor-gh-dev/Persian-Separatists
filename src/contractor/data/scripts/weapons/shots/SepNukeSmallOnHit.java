...
public class SepNukeSmallOnHit implements OnHitEffectPlugin, ProximityExplosionEffect {
	...
	private static void doEffects(Vector2f location) {
		Global.getCombatEngine().addPlugin(new RadiationAreaEffect(location, 10f));
