...
public class SepAndrossMissileAI implements MissileAIPlugin, GuidedMissileAI {
	...
	private final float ECCM = 1.5f;   //A VALUE BELOW 1 WILL PREVENT THE MISSILE FROM EVER HITTING ITS TARGET!
	...
	public SepAndrossMissileAI(MissileAPI missile, ShipAPI launchingShip) {
	...
	public void advance(float amount) {
		...
		//waving
		correctAngle += (float) (1 * WAVE_AMPLITUDE * check * Math.cos(OFFSET + MISSILE.getElapsed() * (2 * MathUtils.FPI / WAVE_TIME)));
