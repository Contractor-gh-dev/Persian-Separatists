...
public class DuskBlacksite extends BaseIndustry implements FleetEventListener {
	...
	protected void upgradeFinished(Industry previous) {
		...
		if (previous instanceof DuskBlacksite) {
			DuskBlacksite prev = (DuskBlacksite) previous;
