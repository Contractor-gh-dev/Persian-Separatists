...
public class DuskWorksite extends PopulationAndInfrastructure implements MarketImmigrationModifier {

	public static final float OFFICER_BASE_PROB = Global.getSettings().getFloat("officerBaseProb");
	public static final float OFFICER_PROB_PER_SIZE = Global.getSettings().getFloat("officerProbPerColonySize");
	public static final float OFFICER_ADDITIONAL_BASE_PROB = Global.getSettings().getFloat("officerAdditionalBaseProb");
	public static final float OFFICER_BASE_MERC_PROB = Global.getSettings().getFloat("officerBaseMercProb");
	public static final float ADMIN_BASE_PROB = Global.getSettings().getFloat("adminBaseProb");
	public static final float ADMIN_PROB_PER_SIZE = Global.getSettings().getFloat("adminProbPerColonySize");


	//public static float IMPROVE_GROWTH_BONUS = 1f;
	public static final float IMPROVE_STABILITY_BONUS = 1f;

	public static final boolean HAZARD_INCREASES_DEFENSE = false;
	...
	public void apply() {
		...
		demand(Commodities.DRUGS, 0);
		demand(Commodities.ORGANS, 0);

		demand(Commodities.SUPPLIES, Math.min(size, 2));
	...
	public static int getMismanagementPenalty() {
		...
		return (int) (overOutposts * Misc.getOutpostPenalty());
	}
	...
	protected static class LampRemover implements EveryFrameScript {
		...
		protected final DuskWorksite industry;

		public LampRemover(SectorEntityToken lamp, MarketAPI market, DuskWorksite industry) {
			this.lamp = lamp;
			this.market = market;
