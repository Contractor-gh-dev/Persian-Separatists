...
public class DuskStardock extends Spaceport implements MarketImmigrationModifier {

	public static final float OFFICER_PROB_MOD = 0.05f;
	public static final float OFFICER_PROB_MOD_MEGA = 0.1f;

	public static final float UPKEEP_MULT_PER_DEFICIT = 0.05f;

	public static final float BASE_ACCESSIBILITY = 0.2f;
	public static final float MEGAPORT_ACCESSIBILITY = 0.9f;
	...
	public void apply() {
		...
		demand(Commodities.SHIPS, size - 3 + extraSize);
...
//			}
	...
	protected void addAlphaCoreDescription(TooltipMakerAPI tooltip, AICoreDescriptionMode mode) {
		...
		String aStr = "" + (int) Math.round(ALPHA_CORE_ACCESSIBILITY * 100f) + "%";
	...
	public void addImproveDesc(TooltipMakerAPI info, ImprovementDescriptionMode mode) {
		...
		String aStr = "" + (int) Math.round(IMPROVE_ACCESSIBILITY * 100f) + "%";
